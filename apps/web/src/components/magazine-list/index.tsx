  ...
  return (
    <>
      {years.map((year) => (
        <ul
          key={year}
          className="not-prose shadow-solid relative my-8 flex overflow-hidden rounded-md border-2 border-gray-900 px-4 pb-6 pt-16 font-mono md:-mx-16 md:px-6 lg:-mx-32 xl:-mx-48 2xl:-mx-64"
        >
