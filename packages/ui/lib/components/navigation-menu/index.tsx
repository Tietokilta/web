...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-full w-max items-center justify-center rounded-md px-4 py-2 transition-colors hover:text-gray-400 focus-visible:text-gray-400 disabled:pointer-events-none disabled:opacity-50 outline-gray-100 data-[active]:underline underline-offset-2 data-[state=open]:underline text-lg font-semibold",
);
...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute left-0 top-full flex w-full justify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "origin-top-center data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 relative h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden border-b-2 border-gray-900 bg-gray-100 text-gray-900",
        className,
      )}
      ref={ref}
      {...props}
