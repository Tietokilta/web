...
function SheetPortal(props: SheetPrimitive.DialogPortalProps): JSX.Element {
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-gray-100/80 backdrop-blur-md dark:bg-stone-950/90",
      className,
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  "data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50  gap-4 border-gray-900 bg-gray-100 transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 dark:bg-stone-900 dark:text-stone-50",
  {
    variants: {
      side: {
